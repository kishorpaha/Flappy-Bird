...
def maingame():
    ...
    while True:
        ...
        if playerFlapped:
            playerFlapped = False
        playerHight = GAME_SPRITES['player'].get_height()
        playery = playery + min(playerValY, GROUNDY - playery - playerHight)
...
if __name__ == '__main__':
    # this will be the main point where are my game start
    pygame.init()
    FPSCLOCK = pygame.time.Clock()
    pygame.display.set_caption('Flappy Bird by Umar')
    ...
    while True:
        welcomescreen() # Shows welcome screen to the user untill he press a button
        maingame()